...
void main()
{
	std::string filename("E:/PCLData/pointcloud/RGBD/kinect4.10/raoliuban4101.pcd");
	//visualizer
	...
	pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> v2_color(cloud_filltered, 255, 0, 0);
	viewer->addPointCloud<pcl::PointXYZ>(cloud_filltered, v2_color, "bunny");
	viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 2, "bunny");
