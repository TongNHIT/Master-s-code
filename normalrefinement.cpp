...
int main()
{
	...
	// Fill cloud...
	pcl::io::loadPCDFile<pcl::PointXYZ>("E:/PCLData/pointcloud/chulihoudianyun/hezizheng.pcd", *cloud);
	...
	*normals1 = *normals;
	...
	//pcl::io::savePCDFileASCII("E:/PCLData/pointcloud/chulihoudianyun/hezizhengnor.pcd", *normals_refined1);
	...
	viewer->addPointCloudNormals<pcl::PointXYZ, pcl::Normal>(cloud, normals_refined1, 1, 0.02, "normals_refined", v2);
